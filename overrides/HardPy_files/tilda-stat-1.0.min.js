!(function () {
  ...
  function a(e) {
    ...
    "hidden" in document &&
      ...
      "onfocusin" in document &&
        ((document.onfocusin = n), (document.onfocusout = o)),
  ...
  function d() {
    ...
    return (
      e.lastIndexOf(".") === e.length - 1 && (e = e.slice(0, -1)),
  ...
  function s() {
    ...
    if (
      ...
      var t,
        ...
        o = "";
      for (
        n = navigator.plugins.length > 20 ? 20 : navigator.plugins.length,
          t = 0;
        t < n;
        t++
      )
        navigator.plugins[t] && navigator.plugins[t].filename
          ...
          : navigator.plugins[t] &&
            navigator.plugins[t].name &&
            (o += navigator.plugins[t].name);
      e += "pl" + o + "|";
    }
    return (
  ...
  function l() {
    (x = n("tildauid")),
      (E = n("tildasid")),
      h
        ? (x || (x = "simple"), E || (E = "simple"))
        : (x || (x = t()), E || (E = t()));
  }
  function u() {
    var e;
    h ||
      (o("tildauid", x, { expires: 7776e3, path: "/" }),
      o("tildasid", E, { expires: 1800, path: "/" }));
  }
  function g(t) {
    if (f.user_agent > "" && -1 != f.user_agent.indexOf("bot")) return !1;
    if (
    ...
    l(),
      ...
      (f.userid = x),
      (f.sessionid = E),
      (f.user_agent = window.navigator.userAgent),
      (f.user_language =
        window.navigator.userLanguage || window.navigator.language),
      e &&
        ((f.projectid = e.getAttribute("data-tilda-project-id") || "0"),
        (f.pageid = e.getAttribute("data-tilda-page-id") || "0"),
        (f.pagealias = e.getAttribute("data-tilda-page-alias") || ""),
        (f.formskey = e.getAttribute("data-tilda-formskey") || "")),
      (f.params = {});
    try {
    ...
    if (
      n > "?" &&
      ((f.pagequery = n.substring(1).toLowerCase()),
      ~f.pagequery.indexOf("utm_"))
    ) {
      var o,
        i = f.pagequery.split("&");
      Array.prototype.forEach.call(i, function (e) {
        (o = e.split("=")).length > 1
          ? "utm_referrer" !== o[0] ||
            (f.referrer && !~f.referrer.indexOf("ohio8.v"))
            ? (f.params[o[0]] = o[1])
            : (f.referrer = o[1])
          : (f.params[o[0]] = "");
      });
    ...
    if (
      ...
      document.getElementById("tildastatscript") &&
        (f.tildastatcode = document.getElementById("tildastatscript").key),
      k)
    )
      try {
        a(function (e) {
  ...
  function p(e) {
    var t = "https://stat.tildacdn.com/event/",
      i;
    h ||
      ((n("tildasid") || "") != f.sessionid &&
        o("tildasid", f.sessionid, { expires: 1800, path: "/" }));
    "" === f.referrer && (f.referrer = n("previousUrl") || ""),
      (f.tildautm = n("TILDAUTM") || ""),
      f.page ||
        (console.log("TildaStat: page empty"),
        (f.page = d()),
        window.location.hash &&
          0 === window.location.hash.indexOf("#!") &&
          (f.page += window.location.hash)),
      "/" === f.page.substring(0, 1) &&
        (f.page = window.location.hostname + f.page);
    var a = m(f),
    ...
    r.open("POST", t, !0),
      ...
      r.send(a),
      f.page &&
        -1 === f.page.indexOf("tilda/scroll") &&
        -1 === f.page.indexOf("tilda/readtime") &&
        -1 === f.page.indexOf("tilda/click") &&
        -1 === f.page.indexOf("tilda/cookieenabled") &&
        ((f.referrer = f.page),
        h || o("previousUrl", f.page, { path: "/", expires: 1800 })),
      (f.page = ""),
    ...
    for (var n in e)
      if (
        ...
        if (Object.keys(e[n]).length)
          for (var o in e[n])
            t += "&" + n + "[" + o + "]=" + encodeURIComponent(e[n][o]);
  ...
  window.tildastat = function (e, t) {
    ...
    switch ((t && i(f, t), e)) {
      ...
      case "readtime":
        k &&
          (v && ((f.page = "/tilda/readtime/"), (v = !1), p(t)),
          setTimeout(function () {
  ...
  if (
    (window.tildastatcookie ||
      (e && (h = "no" === e.getAttribute("data-tilda-cookie"))),
  ...
  void 0 === window.tildastatscroll &&
    e &&
    (k = "yes" === e.getAttribute("data-tilda-stat-scroll"));
  var x = "",
    E = "",
    T = !1;
  ...
  var j = setInterval(function () {
      if (
        (("object" == typeof window.t_jserrors &&
          window.t_jserrors.length > 0) ||
          ("object" == typeof window.t_cdnerrors &&
            window.t_cdnerrors.length > 0) ||
          ("object" == typeof window.t_ajaxerrors &&
            window.t_ajaxerrors.length > 0)) &&
        "function" != typeof t_errors__sendJSErrors
      ) {
        var e = document.createElement("script");
        (e.src = "https://static.tildacdn.com/js/tilda-errors-1.0.min.js"),
          (e.async = !0),
  ...
  _ ||
    (_ = document.querySelectorAll(
      "link[href*='ws.tildacdn.com/project']"
    ).length);
  ...
  (C ||
    (C =
      O &&
      -1 !== A.indexOf("static.tildacdn.com") &&
      -1 !== A.indexOf("tilda.") &&
