...
function t_cover__parallaxUpdate(e, t, o, r) {
  ...
  if (!(i + r < n || i > n + o)) {
    ...
    document.body.style.webkitTransform
      ? (e.style.webkitTransform = "translateY(" + _ + "px)")
      : (e.style.top = _ + "px");
  }
}
function cover_init(e) {
  ...
  if (n) {
    ...
    var v = u.some(function (e) {
      ...
      s;
    if (
      ((window.t_cover__isMobile || "ontouchend" in document) &&
        v &&
        !o &&
        (n.style.backgroundImage = 'url("' + c["cover-bg"] + '")'),
      t_cover__isEditMode())
    )
      if (window.t_cover__isMobile)
        t_cover__setHeightForMobile(r, [
          ".t-cover",
          ".t-cover__filter",
          ".t-cover__carrier",
          ".t-cover__wrapper",
        ]);
      else t_cover__setRecalculatedHeight(r, t_cover__getContentHeight(r));
    setTimeout(function () {
...
function t_cover__setCoverVideoParams(e, t, o, r) {
  var n = "";
  if (
    (t["video-url-youtube"] && (n = "youtube"),
    (t["video-url-vimeo"] ||
      t["video-url-rutube"] ||
      t["video-url-kinescope"] ||
      t["video-url-vkvideo"]) &&
      (n = "iframe"),
    ((!window.t_cover__isMobile && !("ontouchend" in document)) ||
      -1 === ["on", null].indexOf(t["use-image-for-mobile-cover"])) &&
      o)
  )
    switch (
      (t_cover__setStylesForCoverVideo(e, "youtube" === n ? "youtube" : ""), n)
    ) {
      case "youtube":
...
function t_cover__processHTML5Video(e, t, o) {
  ...
  var r,
    n =
      !!(-1 !== t["cover-height"].indexOf("vh")) &&
      parseInt(t["cover-height"], 10) > 100,
    i,
    c =
      !!(-1 !== t["cover-height"].indexOf("px")) &&
      parseInt(t["cover-height"], 10) > window.innerHeight,
    a = !1;
  ...
  window.addEventListener("scroll", function () {
    if (o && a) {
      ...
      i >= d + c
        ...
        : r < d && ((e.style.position = "relative"), (e.style.top = "auto"));
    }
  });
}
...
function t_cover__setStylesForCoverVideo(e, t) {
  (e.style.backgroundColor = "#000000"),
    (e.style.backgroundImage =
      "youtube" === t ? "" : 'url("https://tilda.ws/img/spinner-white.gif")'),
  ...
  if (t) {
    ...
    o &&
      o.addEventListener("click", function () {
        var e, o;
        t.offsetHeight &&
          t_cover__scrollToNextSection(
            t.offsetHeight + t.getBoundingClientRect().top + window.pageYOffset
          );
      });
  }
}
function t_cover__initCovers() {
  if (!t_cover__isEditMode()) {
    var e = document.querySelectorAll(".t-cover__carrier");
    Array.prototype.forEach.call(e, function (e) {
      ...
      window.addEventListener("load", function () {
        var e = Array.prototype.slice.call(
            document.querySelectorAll(".t-cover__wrapper")
          ),
          t = window.t_cover__isMobile
            ? document.documentElement.clientWidth
            : window.innerWidth;
        e.forEach(function (e) {
          !e.closest(".t-slds") &&
            Math.floor(e.getBoundingClientRect().right) > t &&
...
function t_cover__createHTMLVideoCover(e, t, o, r, n, i) {
  if (!e.querySelector("video")) {
    ...
    c + a > _ - l &&
      c <= d + _ + l &&
      t_cover__createAndProcessHTML5Video(e, t, n, i);
  }
}
...
function t_cover__recalcCoverHeight(e, t) {
  ...
  if (o) {
    ...
    if (r && "935" !== n) {
      ...
      ("734" === n || o.querySelector(".t734")) &&
        _.push(".t-slds__items-wrapper");
      var u = "dynamic" === i.getAttribute("data-content-cover-parallax"),
        v = t_cover__getHeightFromAttr(c);
      v &&
        _.forEach(function (e) {
          var t;
          (u && ".t-cover__carrier" === e) ||
            Array.prototype.slice
              .call(o.querySelectorAll(e))
              .forEach(function (e) {
                e && (e.style.height = Math.round(v) + "px");
              });
        });
      var l = t_cover__getHeightFromAttr(c),
      ...
      var p = t_cover__getContentHeight(o),
        h = 40,
        m = 300,
        y = !!i && "100vh" === i.getAttribute("data-content-cover-height");
      (p > m && g < p + h) ||
      d ||
      ((window.t_cover__isMobile || "ontouchend" in document) && t)
        ? (t_cover__setRecalculatedHeight(o, p), t_cover__updateResizeElem(o))
        : window.t_cover__isMobile && y
        ? t_cover__setHeightForMobile(o, _)
        : g > p + h &&
          (t_cover__setRecalculatedHeight(o, p), t_cover__updateResizeElem(o));
    }
  }
...
function t_cover__getContentHeight(e) {
  var t = Array.prototype.slice.call(
    e.querySelectorAll("div[data-hook-content]")
  );
...
function t_cover__getHeightFromAttr(e) {
  if (!e) return 0;
  if (-1 !== e.indexOf("vh")) {
    var t = t_cover__isEditMode() && "100vh" === e ? MENU_HEIGHT : 0;
    return (parseInt(e, 10) * document.documentElement.clientHeight) / 100 - t;
  }
...
function t_cover__setRecalculatedHeight(e, t) {
  ...
  var u = t > i ? t : i,
    ...
    f;
  [
    { selector: ".t-cover-outer", paddingContainer: ".t-cover-outer" },
    { selector: ".t995", paddingContainer: ".t995__wrapper" },
  ].forEach(function (t) {
    e.querySelector(t.selector) &&
      ((g = t_cover__getContainersPaddings(
        e.querySelector(t.paddingContainer)
      )),
      (s = g.top + g.bottom));
  }),
    (u -= s),
    (a || e.querySelector(".t734")) && l.push(".t-slds__items-wrapper"),
    l.forEach(function (t) {
      var o;
      Array.prototype.slice.call(e.querySelectorAll(t)).forEach(function (e) {
        c &&
        e &&
        e.classList.contains("t-cover__carrier") &&
        u < document.documentElement.clientHeight
          ? ((v = 0.2 * document.documentElement.clientHeight),
            (e.style.height = u + v + "px"))
          : e && (e.style.height = u + "px");
      });
    }),
    o.setAttribute("data-content-cover-updated-height", u + v + "px");
  var p = document.createEvent("Event");
  p.initEvent("coverHeightUpdated", !0, !0), o.dispatchEvent(p);
}
...
function t_cover__getPureHeight(e) {
  ...
  return e.clientHeight
    ? e.clientHeight - (t + o)
    : parseInt(window.getComputedStyle(e).height, 10);
}
function t_cover__getFullHeight(e) {
  return e
    ? e.offsetHeight +
        (parseInt(e.style.marginTop) || 0) +
        (parseInt(e.style.marginBottom) || 0)
    : 0;
  var t, o, r;
}
  ...
  var r = window.pageYOffset,
    ...
    c = setInterval(function () {
      (i += n),
        ...
        ((e - r < 0 && window.pageYOffset <= e) ||
          (e - r > 0 && window.pageYOffset >= e)) &&
          (clearInterval(c), document.body.removeAttribute("data-scrollable"));
    }, 10);
}
function t_cover__setHeightForMobile(e, t) {
  t.forEach(function (t) {
    var o = e.querySelector(t),
      r = 0;
    t_cover__isEditMode() &&
      ((r = MENU_HEIGHT), e.querySelector(".t995") && (r += 40)),
      o && (o.style.height = document.documentElement.clientHeight - r + "px");
  });
}
...
function t_cover__isEditMode() {
  var e = document.querySelector(".t-records");
  return !!e && "edit" === e.getAttribute("data-tilda-mode");
}
function t_cover__getContainersPaddings(e) {
