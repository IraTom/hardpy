...
function t_onFuncLoad(t, e, n) {
  ...
  if (a(t) && r()) e();
    ...
    setTimeout(function o() {
      ...
      a(t) && r()
        ? e()
        : ("complete" === document.readyState && l - d > i && !a(t) && s(),
          setTimeout(o, n || 100));
    });
  }
}
      ...
      Array.prototype.forEach.call(t.fixedElements, function (e) {
        ...
        if (
          ...
          if ("fixed" === r || "absolute" === r) {
            ...
            var d = o.getPropertyValue("right");
            d = parseInt(d.replace("px", ""), 10);
            var l = o.getPropertyValue("width"),
            ...
            var h =
                "100%" === l ||
                l === window.innerWidth + "px" ||
                l === window.innerWidth - t.scrollBarWidth + "px" ||
                "100vw" === l,
              p =
                "100%" === s ||
                ...
                "auto" === s ||
                "100vh" === s;
            (!d && 0 !== d) || "auto" === n.style.right || "absolute" === r || h
              ? h &&
                !p &&
                (n.style.width = "calc(100vw - " + t.scrollBarWidth + "px)")
              : (n.style.right = t.scrollBarWidth + d + "px");
          }
        }
      }),
...
(window.browserLang = (
  ...
  t_onReady(function () {
    ...
    if (-1 !== t.indexOf("Android") && (n || e || i || o || r)) {
      ...
      var l = 100 / d.getBoundingClientRect().height;
    ...
    if (
      ...
      for (
        ...
        var i,
          ...
          d = window.pageYOffset + window.innerHeight + 300;
        t_addClass(i, a > 1e3 && a > d ? "r_hidden" : "r_showed"),
          t_addClass(i, "r_anim");
      }
      if (r.length) {
        function l() {
    ...
    function e() {
      ...
      for (var r = 0; r < e.length; r++) {
        ...
        if (
          ...
          document.querySelector('[data-popup-rec-ids="' + d + '"]')
        )
          return;
    ...
    function e() {
      ...
      for (var n = 0; n < h.length; n++) {
        ...
        (o = (i = h[n]).style).height.indexOf("vh") > -1 &&
          ((e = parseInt(o.height) / 100), (l = p + "px"), (o.height = l));
      }
    }
    function n() {
        ...
        for (
          ...
          if (h > e) {
            ...
            console.log(
              ...
              (l.style.wordBreak = h - 3 > e ? "break-word" : "");
          }
        }
    }
    function i(t) {
