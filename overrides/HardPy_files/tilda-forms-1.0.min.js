      ...
      document.addEventListener("keydown", function () {
        ...
        Array.prototype.forEach.call(e, function (t) {
          t.addEventListener("focus", function () {
            "keyboard" === r &&
              ((t.classList.contains("t-input_pvis") ||
                t.classList.contains("t-input-phonemask")) &&
                (t = t.parentElement),
...
function t_forms__removePlaceholder(t) {
  ...
  if ("INPUT" === e.tagName) {
    ...
    o &&
      a &&
      ((window.t_forms__inputData[a] = o), e.setAttribute("placeholder", ""));
  }
}
function t_forms__moveToErrorInput(t, e) {
  ...
  e && (e.removeEventListener("click", r), e.addEventListener("click", r));
}
function t_forms__addPlaceholder(t) {
  ...
  n &&
    o &&
    (e.setAttribute("placeholder", n), (window.t_forms__inputData[o] = ""));
}
...
function t_forms__addAttrAction(t) {
  ...
  Array.prototype.forEach.call(e, function (t) {
    var e;
    "2" === t.getAttribute("data-formactiontype") &&
...
function t_forms__calculateInputsWidth(t) {
  ...
  if (
    ...
    if (r) {
      ...
      if (
        (r.classList.contains("t-form__inputsbox_inrow") ||
          (o = e.querySelectorAll(".t-input-block_width")),
        0 !== o.length)
      ) {
        (r.classList.contains("t-form__inputsbox_vertical-form") ||
          r.closest(".t706")) &&
        ...
        Array.prototype.forEach.call(o, function (t) {
          if (
            ...
            if (
              ...
              0 !== o.length ||
              !(
                (e.classList.contains("t-input-group_inrow") &&
                  !t.classList.contains("t-input-group_widthdef")) ||
                (t.classList.contains("t-input-group_widthdef") &&
                  e.classList.contains("t-input-group") &&
                  !e.classList.contains("t-input-group_inrow"))
              )
            )
              return (
                t.classList.remove("t-input-group_inrow-withsibling"),
          ...
          e &&
            ...
            e.classList.contains("t-input-group_inonerow") &&
            !e.classList.contains("t-input-group_inrow") &&
            (e.classList.add("t-input-group_widthdef"),
            e.classList.contains("t-input-group_inrow-withsibling") ||
              e.classList.add("t-input-group_inrow-last"),
            e.classList.contains("t-input-group_inrow") &&
              t.classList.add("t-input-group_inrow-last")),
            r.classList.contains("t-form__inputsbox_inrow") ||
              t_forms__calculateFieldsWidthInJS(t, a);
        });
        ...
        r.classList.contains("t-form__inputsbox_inrow") &&
          s.length > 0 &&
          t_forms__combineFieldsWithDefWidth(s, t);
      }
    }
  }
}
  ...
  t_forms__createArrWithAllRows(t, "t-input-group_inrow").forEach(function (t) {
    ...
    if (
      ...
      r <= 100 ||
        t.forEach(function (t) {
          t.classList.contains("t-input-group_inrow-last") &&
            ((t.style.marginRight = "calc(100% - (" + (r - 100) + "%)"),
...
function t_forms__combineFieldsWithDefWidth(t, e) {
  var r = [],
    o;
  t_forms__createArrWithAllRows(t, "t-input-group_widthdef").forEach(function (
    t
  ) {
    var e = 4;
    if (t.length > 4)
  ...
  return (
    Array.prototype.forEach.call(t, function (t) {
      for (
        ...
        t.previousElementSibling.classList.contains(e) &&
        !t.previousElementSibling.classList.contains(
          "t-input-group_inrow-last"
        );

      )
        (t = t.previousElementSibling), o.push(t);
      r.push(o.reverse()), (o = []);
    }),
    r
  );
...
function t_forms__calculateFieldsWidthInJS(t, e) {
  ...
  for (var a in o)
    if (t.classList.contains(o[a])) {
      ...
      n &&
        n.classList.contains("t-input-title") &&
        (n.style.width = (e - r * (a - 1)) / a + "px"),
        window.innerWidth < 480 &&
          (t && (t.style.width = "100%"), n && (n.style.width = "100%"));
    }
}
...
function t_forms__initBtnDblClick(t) {
  var e;
  if (
    ((t = t || window.event).target || t.srcElement).closest('[type="submit"]')
  )
  ...
  if (r) {
    ...
    if (o) {
      ...
      var a = o.getAttribute("id"),
        ...
        i = "";
      if (
        (r.tildaSendingStatus && (i = r.tildaSendingStatus),
        !((i && i >= 1) || t_hasClass(r, "t706__submit_disable")))
      ) {
        if (
          (t_addClass(r, "t-btn_sending"),
          ...
          return (
            t_removeClass(r, "t-btn_sending"), void (r.tildaSendingStatus = "0")
          );
        var s,
          l = document
          ...
          c;
        if (
          !o.querySelectorAll(".js-formaction-services").length &&
          1 !== d &&
          !l
        ) {
...
function t_forms__showEmptyFormError(t) {
  ...
  var o = t.querySelectorAll(".t-input")[0],
    a;
  o && t_forms__moveToErrorInput(o.getAttribute("id"), e[0]);
}
function t_forms__showInputErrors(t, e, r) {
  if ("none" !== r.obj) {
    var o = e ? e.querySelectorAll(".t-input-error") : [];
    0 !== o.length &&
      r.type.forEach(function (e) {
        var r,
          a = t_forms__getCustomMessage(t, e) || t_forms__getFieldErrorText(e);
        a &&
...
function t_forms__showFormErrors(t, e, r) {
  ...
  e.type.forEach(function (e) {
    var a = t.querySelectorAll(".js-rule-error-" + e),
      n,
      i = t_forms__getCustomMessage(t, e) || t_forms__getMsg(e),
      s;
    (a.length ? a : t.querySelectorAll(".js-rule-error-all")).forEach(function (
      t
    ) {
      t_forms__setFormErrorMsg(t, i, e), r.add(e, o, t);
    });
  });
}
(window.t_forms__lang = (
    ...
    if (o || a || n) {
      ...
      if (!document.head.querySelector('script[src*="' + i + '"]'))
        ((s = document.createElement("script")).type = "text/javascript"),
          (s.src = "https://static.tildacdn.com/js/" + i + ".min.js"),
          (s.onerror = function () {
  ...
  (window.tildaForm.validate = function (t) {
    for (
      var e = t_forms__getElement(t),
        ...
        a = !0,
        n,
        i = t_forms__getConditionCheckHandler(e).isHiddenByCondition,
        s = 0;
      s < r.length;
      s++
    ) {
      ...
      if (!i(l)) {
        var d = !!parseInt(l.getAttribute("data-tilda-req") || 0, 10),
          c = l.getAttribute("data-tilda-rule") || "none",
          u = "",
          m = "",
          ...
          switch (c) {
            ...
            case "url":
              (u =
                ...
                w.length &&
                  ((m = (m =
                    (m = w.split("//")) && m.length > 1 ? m[1] : m[0]).split(
                    "/"
                  )) &&
                  m.length &&
                  m[0]
                    ? (m = m[0]).match(u) || _.type.push("url")
                    : ((m && !m[0]) || _.type.push("url"), (m = "")));
              break;
            case "phone":
              ...
              x &&
                ...
                (u = new RegExp(A, "gi")),
                ((y.length && !y.match(u)) ||
                  1 == (m = y.replace(/[^0-9]+/g, "")).indexOf("000") ||
                  (1 == m.indexOf("111") && "9" != m.substring(0, 1)) ||
                  (1 == m.indexOf("222") && "5" != m.substring(0, 1)) ||
                  1 == m.indexOf("333") ||
                  1 == m.indexOf("444") ||
                  (1 == m.indexOf("555") && "0" != m.substring(0, 1)) ||
                  (1 == m.indexOf("666") && "0" != m.substring(0, 1)) ||
                  (1 == m.indexOf("8888") && "4" != m.substring(0, 1))) &&
                  _.type.push("phone");
              break;
            case "number":
              (u = /^[0-9]+$/gi),
            ...
            case "date":
              t_onFuncLoad("t_datepicker__readDateFromInput", function () {
                ...
                y.length > 0 &&
                  !t_datepicker__isDateValid(t) &&
                  _.type.push("date");
              });
              break;
            case "time":
              (u = /^[0-9]{2}[:\.][0-9]{2}$/gi), //! TODO: 00:00 - 23:59. Заменить на /^([0-1][0-9]|2[0-3])[:\.][0-5][0-9]$/gi
            ...
            case "chosevalue":
              var S;
              "true" === l.getAttribute("data-option-selected") ||
                _.type.push("chosevalue");
              break;
            case "promocode":
              "y" !== v ||
                !y.length ||
    ...
    if ("y" === v) {
      var k = window.tcart_minorder > 0,
        C = window.tcart_mincntorder > 0,
        j,
        _,
        _;
      if (k)
        if (
          ...
          (_ = { obj: {}, type: [] }).type.push("minorder"), o.push(_);
      if (C && window.tcart.total < window.tcart_mincntorder)
        (_ = { obj: {}, type: [] }).type.push("minquantity"), o.push(_);
    }
    return (
      a &&
        !o.length &&
        r.length &&
        (o = [{ obj: "none", type: ["emptyfill"] }]),
      o
    );
  }),
  (window.tildaForm.hideErrors = function (t) {
    if ("object" != typeof t || t.length) {
      var e = t_forms__getElement(t),
        ...
        a = e.querySelectorAll(".js-error-rule-all"),
        n = e.querySelectorAll(".js-successbox"),
  ...
  (window.tildaForm.showErrorInPopup = function (t, e) {
    ...
    var o = r.getAttribute("id"),
      a = r.getAttribute("data-inputbox");
    a || (a = ".blockinput");
    var n = "",
      i = !1,
      s = !0,
    ...
    m ||
      ...
      t_addEventListener(
        ...
        function (t) {
          var e, r;
          if (
            ((t = t || window.event).target || t.srcElement).closest(
              ".js-errorbox-close"
            )
          )
            return (
    ...
    for (var p = 0; p < e.length; p++)
      if (e[p] && e[p].obj) {
        ...
        f && (n = f.closest(a)),
          n &&
            ((d = n.querySelectorAll(".t-input-error")),
        ...
        for (var _ = 0; _ < e[p].type.length; _++) {
          var w = e[p].type[_],
            y = t_forms__getMsg(w);
          (c = ""),
            (l = r.querySelector(".js-rule-error-" + w))
              ? (l.textContent && l.innerText) || !y || -1 !== u.indexOf(y)
                ? ((c = l.textContent || l.innerText),
                  -1 === u.indexOf(c) &&
                    (u = u + '<p class="t-form__errorbox-item">' + c + "</p>"))
                : (u = u + '<p class="t-form__errorbox-item">' + y + "</p>")
              : y &&
                -1 === u.indexOf(y) &&
                (u = u + '<p class="t-form__errorbox-item">' + y + "</p>"),
            i &&
              (!c && t_forms__getMsg(w + "field")
                ? (c = t_forms__getMsg(w + "field"))
                : y && (c = y),
              c &&
                n &&
    ...
    if (u) {
      ...
      if (
        ...
        if (g && g.length) {
          var v,
            b = '.t1093 .t-popup[data-tooltip-hook="' + g[g.length - 1] + '"]',
            E = document.querySelector(b),
            F = E ? getComputedStyle(E).zIndex : 0,
            x;
    ...
    if (
      ...
      (window.t_forms__errorTimerID = window.setTimeout(function () {
        t_fadeOut(m),
          (d = r.querySelectorAll(".t-input-error")),
          Array.prototype.forEach.call(d, function (t) {
            (t.innerHTML = ""), t_fadeOut(t);
          }),
          (window.t_forms__errorTimerID = 0);
  ...
  (window.tildaForm.showErrors = function (t, e, r) {
    ...
    for (
      var n,
        i = (r || {}).inputBoxSelector,
        s,
        l = void 0 === i ? o.getAttribute("data-inputbox") || ".blockinput" : i,
      ...
      if (m && m.obj) {
        ...
        if ((p = t_forms__getElement(p))) {
          var f = p.closest(l);
          f && f.classList.add("js-error-control-box"),
            t_forms__showInputErrors(o, f, m),
            t_forms__showFormErrors(o, m, d);
        }
      }
    }
    return (
      o.querySelectorAll(".js-errorbox-all").forEach(function (t) {
    ...
    if (!r) {
      ...
      t_addEventListener(r, "click", function (t) {
        ...
        t_addEventListener(a, "keydown", function (t) {
          var e;
          27 == ((t = t || window.event).keyCode || t.which) &&
            window.tildaForm.closeSuccessPopup();
        });
    }
    (o.innerHTML = t),
  ...
  (window.tildaForm.successEnd = function (
    formNode,
    successUrl,
    successCallback
  ) {
  ...
  (window.tildaForm.send = function (
    formNode,
    btnSubmitNode,
    formType,
    formKey
        ...
        (xhr.onreadystatechange = function () {
          if (4 === xhr.readyState)
            if (xhr.status >= 200 && xhr.status < 400) {
                ...
                if ("{" == o.substring(0, 1)) {
                  ...
                  if ("object" == typeof a)
                    if (a && a.message && "OK" !== a.message)
                      ...
                      var n,
                        i = (n = t_forms__getErrorContainers(
                          form,
                          "Unknown error. Please, try again later."
                        )).errorBoxes,
                        s = n.allError;
              ...
              window.Tilda &&
              "function" == typeof window.Tilda.sendEventToStatistics
                ? window.Tilda.sendEventToStatistics(l, d, "", 0)
                : "undefined" != typeof ga && "tilda" !== window.mainTracker
                ? ga("send", { hitType: "pageview", page: l, title: d })
                : window.mainMetrika > "" &&
                  window[window.mainMetrika] &&
                  window[window.mainMetrika].hit(l, {
                    title: d,
                    referer: window.location.href,
                  }),
                t_triggerEvent(form, "tildaform:aftersuccess"),
              ...
              t_removeClass(btnSubmit, "t-btn_sending"),
                (btnSubmit.tildaSendingStatus = "0");
              var n,
                i = (n = t_forms__getErrorContainers(form, "")).errorBoxes,
                s = n.allError,
                o = xhr.responseText;
              Array.prototype.forEach.call(s, function (t) {
                o
                  ? (t.innerHTML =
                      o + ". Please, try again later. [" + xhr.status + "]")
                  : xhr.statusText
                  ? (t.innerHTML =
                      "Error [" +
                      xhr.statusText +
  ...
  (function () {
    try {
      ...
      if (
        ...
        for (a in n)
          "function" != typeof n[a] &&
            "utm_" == (o = n[a].split("="))[0].substring(0, 4) &&
            (r = r + n[a] + "|||");
        if (
          r.length > 0 &&
...
var t_forms__setFormErrorMsg = function t(e, r) {
  e.getAttribute("data-rule-filled")
    ...
    : r &&
      ((e.innerHTML =
        '<a href="#" class="t-form__errorbox-link">' + r + "</a>"),
      (e.style.display = "block"));
};
...
function t_forms__getCustomMessage(t, e) {
  ...
  return r.setAttribute("data-original-msg", a), a;
}
function t_forms__createErrorFocusHash() {
  var t = {};
  return {
    add: function e(r, o, a) {
      !t[r] && o && (t_forms__moveToErrorInput(o, a), (t[r] = o));
    },
  };
}
...
function t_parseScripts(t, e) {
  ...
  Array.prototype.forEach.call(r, function (e) {
    for (
      var r = document.createElement("script"), o = 0;
...
function t_forms__onSuccess(t) {
  var e = t_forms__getElement(t),
    ...
    a = e.querySelector(".t-form__inputsbox"),
    ...
    u = e.querySelector(".t-form__successbox"),
    m = u ? u.getBoundingClientRect().top + window.pageYOffset : 0,
    p = 0,
...
function t_serializeArray(t) {
  for (
    var e = [],
      ...
      o,
      a = t_forms__getConditionCheckHandler(t).isHiddenByCondition,
      n = 0;
    n < r.length;
    n++
  )
    if (
      !(
        !r[n].name ||
        r[n].disabled ||
        ["file", "reset", "submit", "button"].indexOf(r[n].type) > -1 ||
        a(r[n])
      )
    )
      if ("select-multiple" !== r[n].type)
        (["checkbox", "radio"].indexOf(r[n].type) > -1 && !r[n].checked) ||
          e.push({ name: r[n].name, value: r[n].value });
      else
        for (var i = r[n].options, s = 0; s < i.length; s++)
          i[s].selected && e.push({ name: i[s].name, value: i[s].value });
  return e;
}
...
function t_forms__formData(t) {
  for (var e = "", r = 0; r < t.length; r++)
    "" !== e && (e += "&"),
      (e +=
        encodeURIComponent(t[r].name) + "=" + encodeURIComponent(t[r].value));
